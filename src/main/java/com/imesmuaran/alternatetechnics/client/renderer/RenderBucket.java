...
public class RenderBucket extends TileEntitySpecialRenderer {
	...
	// Attribute
		private ModelBucketT model;
		
		public static final ResourceLocation texture = new ResourceLocation("alternatetechnics", "models/Bucket.png");
		
		public RenderBucket(ModelBucketT model) {
			this.model = model;
		}
