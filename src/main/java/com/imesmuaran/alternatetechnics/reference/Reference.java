...
{
    //** Information **//
    public static final String MOD_ID = "alternatetechnics";
    public static final String MOD_NAME = "Alternate Technics";
    public static final String VERSION = "1.7.2-0.1.4";
